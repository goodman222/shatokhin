...
createApp({
  data() {
    return {
      categorys: [
        // "Возврат денег/замена товара/ремонт товара или возврат денег за некачественные услуги"
        {
          name: "Возврат денег/замена товара/ремонт товара или возврат денег за некачественные услуги",
          question: {
            text: null,
          },
        },
        // "Другие вопросы по защите прав потребителей"
        {
          name: "Другие вопросы по защите прав потребителей",
          question: {
            text: null,
          },
        },
